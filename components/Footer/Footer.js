...
const Footer = () => {
  ...
  const date = new Date()
  return (
    <div className="flex flex-row w-full justify-center fixed bottom-0 text-white bg-black">
      <div className=" flex flex-row w-full max-w-4xl py-3">
          ...
          <div className="flex flex-row justify-end space-x-4 items-center">
            ...
            <Link href={'https://github.com/SheikhAfham-1993'} target="_blank">
              <svg
                ...
                class="octicon octicon-mark-github v-align-middle color-fg-default fill-white"
              >
